...
_BASE_URL     = "https://v1.afl.api-sports.io"
_LEAGUES_TTL  = 86400
...
_STATUS_MAP = {
    "NS": "pre", "TBD": "pre", "CANC": "pre", "SUSP": "pre",
    "Q1": "in", "Q2": "in", "Q3": "in", "Q4": "in", "OT": "in",
    "FT": "post", "AOT": "post",
}

_FEATURED_LEAGUES = [
    {"id": 1, "name": "AFL (Austrália)", "category": "Oceania", "country": "Australia"},
    {"id": 2, "name": "AFLW",           "category": "Oceania", "country": "Australia"},
]
...
def _parse_leagues(payload: dict) -> list[dict]:
    ...
    for item in (payload.get("response") or []):
        ...
        result.append({
            ...
            "category": country.get("name", "Oceania"),
    ...
    for item in (payload.get("response") or []):
        for bookmaker in (item.get("bookmakers") or []):
            for bet in (bookmaker.get("bets") or []):
                ...
                if "winner" in name or "head to head" in name:
